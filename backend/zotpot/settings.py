"""
Django settings for zotpot project.
"""
...
WSGI_APPLICATION = 'zotpot.wsgi.application'
ASGI_APPLICATION = 'zotpot.asgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env('POSTGRES_DB', default='zotpot'),
